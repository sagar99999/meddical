    ...
    return (
        <div className="border group rounded-sm overflow-hidden">
            <div className="aspect-square relative text-black">
                <Image src={image} alt={title} fill sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw" className="absolute object-cover" />
            ...
            <div className="py-5 p-5">
                <p className="text-3xl font-semibold tracking-wide mb-4 line-clamp-1">{title}</p>
                <p className="tracking-wider mb-4 line-clamp-4">
                    {description}
                </p>
                <div className="flex gap-2 items-center">
                    <Link className="text-brand text-lg hover:underline" href={`/services/${slug}`}>Learn More</Link>
