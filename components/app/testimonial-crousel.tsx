...
export default function TestimonialCarousel() {
    ...
    return <div className="relative bg-brand-1">
        ...
        <Image src="/images/hero-2.jpg" alt="doctors image" fill className="absolute object-cover" />
...
function CarouselSlide() {
    return <div className="py-35 relative">
        <p className="max-w-165 text-white mx-auto text-2xl  text-center leading-10 ">
